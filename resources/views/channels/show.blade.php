        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="mt-0 header-title d-flex justify-content-between">{{ $channel->name }}
                    ...
                    <table class="table">
                        ...
                        <tbody>
                          @foreach($videos as $video)
                              ...
                              <tr>
                                 <td><img width="40px" height="40px" src="{{ $video->thumbnail }}"> </td>
                                 <td>{{ $video->title }}</td>
                                 <td>{{ $video->views }}</td>
                                 ...
                                 <td>
                                   @if($video->percentage === 100)
                                    ...
                                    <a href="/videos/{{ $video->id }}/delete" class="btn btn-sm btn-danger">Delete</a>
                                   @endif
                                 </td>
                              </tr>
