                      ...
                      <channel-uploads :channel="{{ $channel }}" inline-template>
                          <div class="col">
                              <div class="card p-3 d-flex justify-content-center align-items-center" v-if="!selected">
                                  ...
                                  <p class="text-center"><a class="btn btn-secondary btn-sm" onclick="document.getElementById('video-files').click()" role="button" style="color: white">Upload Videos</a></p>
                              </div>
